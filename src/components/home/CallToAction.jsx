    ...
    >
      ...
      >
        ...
        <p className="text-gray-300 mt-4">
          Inscrivez-vous dès maintenant pour participer à nos événements de
          rencontres.
        </p>
        <p className="text-gray-300 mt-4">
        ...
        <div className="mt-8">
          <motion.button
            ...
            className="px-6 py-3 bg-gold text-black font-bold text-lg rounded-lg border-2 border-gold hover:bg-transparent hover:text-gold transition-all"
